    ...
    <div className={`flex items-center gap-2 ${className}`}>
      ...
      {error && (
        <div className="relative group">
          ...
          <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-slate-900 border border-slate-600 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity z-10 whitespace-nowrap">
            {error}
          </div>
        </div>
      )}
